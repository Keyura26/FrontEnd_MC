...
// event bubbble  (star container is ntg but an object and it has an method addeventlistener)
...
starContainer.addEventListener("mouseover", function (e) {
    let elem = e.target;
    let isrequired = elem.hasAttribute("idx");  //we prefer to use hasAttribute here instead of getattribute
    if (!isrequired)                   // as getAttribute(classname) can be changed later as we can append 
        return;                       // new class for colour
