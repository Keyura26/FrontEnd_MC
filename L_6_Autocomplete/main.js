...
// Debouncing - It takes action to reduces no of api calls made and makes sure to call
//  the request once the user has typen entire value as Hello instead of making many calls
//  at h,e,l,l,o(i.e after lifting the key)


function debounce(fn, delay = 1000) { //If there is no interval greater than 1000 sec it will not take the input
    // intial 
    let timerId;
